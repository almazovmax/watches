...
<div class="main w3l">
    ...
    <a href="/catalog" class="back">CATALOG</a>
    <a href="/news" class="back">NEWS</a>
    <a href="/about" class="back">ABOUT</a>
    <a href="/contact" class="back">CONTACT</a>
    ...
    <div class="footer agileits">
        <p>© <?= date("Y");?> Luxury Watches. All Rights Reserved | Design by  <a href="http://vk.com/almazovmax" target="_blank">M. Almazov</a> </p>
    </div>
</div>
