    ...
    <div class="container">
        <div class="breadcrumbs-main">
            <ol class="breadcrumb">
                ...
                <li class="active"><?php echo "{$product['brand']} {$product['name']}"; ?></li>
            </ol>
        </div>
    </div>
</div>
                ...
                <div class="sngl-top">
                    ...
                    <div class="col-md-7 single-top-right">
                        <div class="single-para simpleCart_shelfItem">
                            <h2><?php echo "{$product['brand']} {$product['name']}"; ?></h2>
                            <div class="star-on">
                            ...
                            <ul class="tag-men">
                                <li><span>TAG:</span>
                                    <span class="women1"><?= ucfirst($product['sex']);?>, <?= $product['brand'];?></span></li>
                                <li><span>SKU:</span>
                        ...
                        <?php foreach ($recommended as $recommend):?>
                            <div class="col-md-4 product-left p-left">
                                <div class="product-main simpleCart_shelfItem">
                                    <a href="/product/<?= $recommend['id'];?>" class="mask"><img class="img-responsive zoom-img" src="<?= $recommend['image'];?>" alt="" /></a>
                                    <div class="product-bottom">
                                        <h3><?= $recommend['brand'];?></h3>
                                        <p><?= $recommend['name'];?></p>
                                        <h4><a class="item_add" href="#"><i></i></a> <span class=" item_price">$ <?= $recommend['price'];?></span></h4>
                                    </div>
                                    <?php if($recommend['sale']):?>
                                        <div class="srch">
